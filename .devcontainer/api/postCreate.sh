...
#
# In production, the Lambda Dockerfile flattens functions/api/src/*.py
...
SRC_DIR=/workspace/functions/api/src
SHARED_DIR=/workspace/shared
TESTS_DIR=/workspace/functions/api/tests
PYTEST_CFG=/workspace/functions/api/pytest.ini
TASK_DIR=/var/task
REQS=/workspace/functions/api/requirements-test.txt
