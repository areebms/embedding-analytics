...
#
# In production, the Lambda Dockerfile flattens functions/align-kvectors/src/*.py
...
SRC_DIR=/workspace/functions/align-kvectors/src
SHARED_DIR=/workspace/shared
TESTS_DIR=/workspace/functions/align-kvectors/tests
PYTEST_CFG=/workspace/functions/align-kvectors/pytest.ini
TASK_DIR=/var/task
REQS=/workspace/functions/align-kvectors/requirements-dev.txt
...
# Link each .py file in functions/align-kvectors/src/ as a sibling of /var/task.
